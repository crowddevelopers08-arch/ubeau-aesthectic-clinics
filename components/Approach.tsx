...
export default function Approach() {
  return (
    <div id="approach" className="grid grid-cols-1 lg:grid-cols-2 items-stretch bg-brand-off-white">
      <div className="flex flex-col justify-center px-4 sm:px-8 lg:px-20 py-1 sm:py-2 lg:py-4">
        ...
        <h2 className="font-outfit text-[clamp(1.8rem,3.5vw,3.6rem)] font-normal leading-[1.15] text-brand-black mb-6 sm:mb-8">
      ...
      <div className="group relative min-h-20 sm:min-h-28 lg:min-h-36 overflow-hidden">
        <Image
          src="/abbbc.jpg"
        ...
        />
        {/* gradient blends image into the cream background */}
        <div
