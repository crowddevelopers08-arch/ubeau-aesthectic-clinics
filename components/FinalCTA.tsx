...
export default function FinalCTA() {
  return (
    <div className="relative overflow-hidden px-20 py-44 text-center max-lg:px-6 max-lg:py-28">
      <Image
      ...
      <div className="relative z-[2] max-w-[720px] mx-auto">
        <div className="flex items-center justify-center gap-3 mb-[1.4rem]">
        ...
        <h2 className="font-cormorant text-[clamp(2.5rem,4.5vw,4rem)] font-light text-white leading-[1.12] mb-[1.1rem]">
          The Best Skin of Your{' '}
          <em className="italic text-brand-pink-light">Life</em> Starts Here
        </h2>

        <p className="font-outfit text-[0.95rem] font-light text-white/60 mb-12 leading-[1.95]">
